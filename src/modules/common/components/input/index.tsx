      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex relative z-0 w-full txt-compact-medium">
          <input
            ...
            placeholder=" "
            required={required}
            className="pt-4 pb-1 block w-full h-11 px-4 mt-0 bg-gray-50 border border-gray-200 rounded-lg appearance-none focus:outline-none focus:ring-2 focus:ring-main-color/20 focus:border-main-color hover:bg-gray-100 transition-colors"
            {...props}
            ref={inputRef}
          />
          <label
