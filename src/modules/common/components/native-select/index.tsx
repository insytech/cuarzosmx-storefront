    ...
    return (
      <div>
        <div
          ...
          className={clx(
            "relative flex items-center text-base-regular border border-gray-200 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors focus-within:ring-2 focus-within:ring-main-color/20 focus-within:border-main-color",
            className,
            {
