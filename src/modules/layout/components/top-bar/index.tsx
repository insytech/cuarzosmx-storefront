    ...
    return (
        <div className="w-full bg-main-color text-white text-center text-xs py-2 font-semibold flex justify-between items-center px-8">
            ...
            <div className="flex gap-4">
                <LocalizedClientLink href="https://www.instagram.com/cuarzosmx_oficial/" className="hover:opacity-80" target="_blank" rel="noopener noreferrer">
                    {/* Instagram icon */}
                ...
                <LocalizedClientLink href="https://www.facebook.com/cuarzosmx" className="hover:opacity-80" target="_blank" rel="noopener noreferrer">
                    {/* Facebook icon */}
