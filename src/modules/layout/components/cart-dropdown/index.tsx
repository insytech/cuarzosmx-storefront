    ...
    >
      <Popover className="relative h-full">
        ...
        >
          <PopoverPanel
            static
            className="hidden small:block absolute top-[calc(100%+1px)] right-0 bg-white border-x border-b border-gray-200 w-full sm:w-[380px] lg:w-[480px] text-ui-fg-base z-50 rounded-b-lg shadow-lg"
            ...
            {cartState?.items?.length ? (
              <>
                ...
                <div className="p-4 flex flex-col gap-y-4 text-small-regular">
                  ...
                  <LocalizedClientLink href="/cart" passHref>
                    <Button
                      className="w-full bg-main-color hover:bg-main-color/90 text-white"
                      size="large"
              ...
              <div>
                <div className="flex py-16 flex-col gap-y-4 items-center justify-center">
                  <div className="bg-main-color text-small-regular flex items-center justify-center w-6 h-6 rounded-full text-white">
                    <span>0</span>
                  </div>
