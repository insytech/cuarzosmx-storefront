...
export default function HeroBlock() {
    return (
        <section className="w-full min-h-[600px] lg:min-h-[800px] flex flex-col lg:flex-row px-10 gap-2">
            {/* Columna Izquierda: 50% en desktop, 100% en móvil */}
            <div className="w-full lg:w-1/2 min-h-[220px] flex items-center justify-center bg-main-color-light relative p-2">
            ...
            <div className="w-full lg:w-1/4 min-h-[180px] flex flex-col gap-2">
                {/* Sección superior */}
                <div className="h-40 lg:h-1/2 flex items-center justify-center bg-quartz-pink border-b border-beige p-2">
                ...
                {/* Sección inferior */}
                <div className="h-40 lg:h-1/2 flex items-center justify-center bg-quartz-green p-2">
            ...
            <div className="w-full lg:w-1/4 min-h-[180px] flex flex-col gap-2">
                {/* Sección superior */}
                <div className="h-40 lg:h-1/2 flex items-center justify-center bg-gold border-b border-beige p-2">
                    <div className="w-24 h-24 rounded-lg bg-beige/60 flex items-center justify-center">
                        <span className="text-main-color-dark text-sm">[Placeholder]</span>
                    </div>
                </div>
                {/* Sección inferior */}
                <div className="h-40 lg:h-1/2 flex items-center justify-center bg-light-gray p-2">
