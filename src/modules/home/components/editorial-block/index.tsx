...
export default function EditorialBlock() {
    return (
        <section className="w-full py-16 bg-white relative overflow-hidden">
            ...
            />
            <div className="section-container max-w-[1800px] mx-auto px-4 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative">
                    {/* Columna Izquierda - Texto */}
                    <div className="space-y-6 z-20">
                        <Heading
                            level="h2"
                            className="text-[2.8rem] md:text-[3.5rem] font-extrabold text-left text-gray-800 leading-tight"
                        >
                    ...
                    <div className="relative flex items-center justify-center min-h-[480px] md:min-h-[520px] px-8">
                        ...
                        <div className="relative z-20 rounded-full border-[16px] border-white shadow-2xl w-[360px] h-[360px] flex items-center justify-center bg-white flex-shrink-0 float-animation float-animation-delay-1">
                            <img
                                src="/block/cuarzo-amatista-piedras-preciosas-3.webp"
                                alt="Cuarzo principal"
                                className="object-cover w-[328px] h-[328px] rounded-full"
                            />
                        </div>

                        {/* Imagen superior izquierda */}
                        <div className="absolute top-20 -left-4 z-30 flex items-center justify-center float-animation float-animation-delay-2">
                            <div className="rounded-full border-[10px] border-white shadow-xl w-[120px] h-[120px] bg-white flex items-center justify-center">
                                <img
                        ...
                        <div className="absolute bottom-20 -right-4 z-30 flex items-center justify-center float-animation float-animation-delay-2">
                            <div className="rounded-full border-[10px] border-white shadow-xl w-[120px] h-[120px] bg-white flex items-center justify-center">
                                <img
